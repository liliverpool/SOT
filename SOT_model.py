# -*- coding: utf-8 -*-
"""
Created on Thu May 1 18:06:50 2018
...
def recompute_w_topic_distribution_for_SOT_2(d, w, td_mean, td_previuos, dw_means, dw_previuos, eta, gamma, total_beta_mean_list, total_beta_previous_list):
    new_topic_distribution = np.ones([topic_num])
    num_list = np.ones([topic_num])
...
#            total_beta_mean_list = get_beta_total(dw_means, gamma_list[d][1])
        else:
        ...
        for w in range(0, len(docs_list[d])):
            if(model_name == "SOT"):
                new_pdf = recompute_w_topic_distribution_for_SOT_2(d, w, td_mean, td_previuos, dw_means, dw_previous, eta_list[d], gamma_list[d], total_beta_mean_list, total_beta_previous_list)
